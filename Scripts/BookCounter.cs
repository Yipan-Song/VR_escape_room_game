...
public class BookCounter : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        // Detect if the grabbed book is inside a collider
        ...
        // Comparing the the order of books when there are five on the same layer
        ...
        if (firstbookinLayer && fifbookinLayer && fourbookinLayer && thirbookinLayer && secbookinLayer && bookAmountCurrentLayer == 5)
        {
            ...
            // Sorting out the user input by its Z position
